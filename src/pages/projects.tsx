...
export default function Projects() {
  return (
    <>
      <NextSeo
        title="Projects by Animesh Manna - React and Frontend Developer Portfolio"
        description="Explore a collection of projects by Animesh Manna, a seasoned React and Frontend Developer. From innovative web applications to responsive interfaces, discover the depth and diversity of my work."
        canonical={`${siteMetadata.siteUrl}/projects`}
        openGraph={{
          url: `${siteMetadata.siteUrl}/projects`,
          title:
            "Discover Projects by Animesh Manna - React and Frontend Developer",
          description:
            "Explore a showcase of projects crafted by Animesh Manna, a React and Frontend Developer. Witness the fusion of creativity and technology in web development.",
          images: [
            {
